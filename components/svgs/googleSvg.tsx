    ...
    return (
        <div onClick={loginWithGoogle}>
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M21.8055 10.0415H21V10H12V14H17.6515C17.2571 15.1082 16.5467 16.0766 15.608 16.785L15.6095 16.7845L18.7045 19.404C18.454 19.6285 22 17.5225 22 12C22 11.3295 21.931 10.675 21.8055 10.0415Z" fill="#1976D2" />
            </svg>
        </div>
    )
}
